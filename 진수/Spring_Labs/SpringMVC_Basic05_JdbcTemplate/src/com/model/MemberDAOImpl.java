	...
	*/
	...
	public MemberVO selectMemberById(String id) throws SQLException {
		...
		/*
            ...
            **********아래 처리 자동화된 코드를 원하면 : select 컬럼명  == VO 객체 변수명이 같아야 한다!!!**********
		*/
		String sql="select id,name,pwd,email,age from usermember where id=?";
		//쿼리문 실행 -> resultset 에 결과 담아서 > vo 객체 생성 > rs 에서 vo 객체 데이터 넣어주고 settter 사용 해 데이터 넣고 > vo 객체 리턴 하는것
		//기존 하던위 프로세스를 BeanPropertyRowMapper 가 알아서 다 해줌. 단, BeanPropertyRowMapper 결과된 조회값이 없어 0이 된다면 에러가 뜨니 예외처리 해줘야 함! (여기선 안되어 있음)
