...
<body>
	...
	//사진 지우기 해놓고 수정 취소를 할 수 있기 때문에
	 function imgdelete(str) {
		...
		<!-- writer -->
		<div class= "container"  >
			<form name = "db" id="db" action="contenteditok.db?cp&ps=" method = "post" enctype="multipart/form-data">
				
				<input type="hidden" name="contentnum" value="1">
				...
				<table width="100%" border="0" align="center">
					...
					<tr>
						...
						<td align="left"><input type="text" name= "title" id="title" size="50" value="제목"></td>
						<td style="visibility:hidden;">empty</td>
					</tr>
					<tr>
						<td  align="center" ></td>
		  ...
		  <!--     					<option data-class="podcast">강남</option>   -->
					...
					<table id="image" style="border: 1px solid black">
						<tr>
							<td  width="5%"><img id="" alt="에러 ip주소를 확인해주세요" src="" style="width: 100px; height: 100px" onclick="imgdelete(this)"/><p>사진 클릭시 삭제</p></td>
						</tr>
					</table>
					<table id="imgfile" style="border: 1px solid black">
						...
						<tr>
							<td width="5%" align="center" ><input type="file" class= "form-control" accept="image/*" name="uploadfiles" id="uploadfiles" 
></td>
						</tr>
					...
					<table  width="100%" border="0" align="center">
						<tr>
							<td colspan="5">
								<textarea rows="10" cols="60" name= "content" id="content">내용</textarea>
									<script type="text/javascript">
