...
/*
	//1.전통적으로 Client 요청 데이터 받기 (Spring에서 더 이상 사용 안해요!!!)
...
/*	
	...
	넘어오는 parameter 가 DTO 타입의 memberfield 명과 같다면,
	 ...
	 2.1 NewArticleCommand 객체 IOC 컨테이너에 id="newArticleCommand" 자동 생성....
...
/*	
	3.이름이 자동으로 생성되는 것이 싫어요!!
	submit(@ModelAttribute("Articledata")NewArticleCommand command)
	: 자동으로 생성되는 객체 변수명을 제어. Key 값을 강제로 Articledata로 정의
